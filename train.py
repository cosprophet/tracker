...
def run(args):
    ...
    model = Tracker(args, ontology, vocab)
    model.save_config()
...
def get_args():
    ...
    parser.add_argument('--ed', help='word embedding size', default=400, type=int)
    parser.add_argument('--hd', help='hidden state size', default=75, type=int)
